...
export default function Contact() {
    ...
    return (
        ...
        <div className="bg-[#f8f4ee] text-[#222831] min-h-screen relative overflow-hidden">
            ...
            <section className="relative bg-[#222831] text-white py-32 px-6 overflow-hidden">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-[#F9E0BB] mb-8 leading-tight">
            ...
            <Reveal>
                ...
                >
                    ...
                    <div className="max-w-5xl mx-auto relative z-10">
                        ...
                        <div className="bg-white/80 backdrop-blur-md shadow-[0_20px_60px_rgba(0,0,0,0.08)] rounded-[32px] p-10 md:p-14 border border-[#eadbc8]">
            ...
            <section className="relative bg-[#222831] text-white py-20 px-6 overflow-hidden">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-[#F9E0BB] mb-6 leading-tight">
